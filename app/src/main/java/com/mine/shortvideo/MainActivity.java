...
import com.mine.shortvideo.activity.UserActivity;
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.img_comment:
                ...
                break;
            case R.id.img_share:
                new ShareAction(MainActivity.this).withText("hello").withMedia(video).setDisplayList(SHARE_MEDIA.SINA,SHARE_MEDIA.QQ,SHARE_MEDIA.WEIXIN,SHARE_MEDIA.WEIXIN_CIRCLE)
